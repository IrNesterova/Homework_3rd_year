...
public class CvssV2 implements Cvss {
    ...
    public us.springett.cvss.Score calculateScore() {
        ...
        return new us.springett.cvss.Score(baseScore, roundNearestTenth(impactSubScore), roundNearestTenth(exploitabalitySubScore), temporalScore);
    }
